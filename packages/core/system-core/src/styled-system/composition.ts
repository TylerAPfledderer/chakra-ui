...
import type { CssVarProperties, Nested } from "./types"

/**
 * Composition style object type - simplified for framework-agnostic use
 */
type CompositionStyleObject<Property extends string> = Nested<
  FilterStyleObject<Property> & CssVarProperties
>

type FilterStyleObject<P extends string> = {
  [K in P]?: Dict | string | number | undefined
}
